...
Wildtrax keeps track of image batches using "location folders". We created our own location folders by combining images within the same retrieval, site and location IDs. The standard format we used for location folders follows this convention: 
