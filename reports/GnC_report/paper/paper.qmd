...
if (!file.exists("analysis/data/derived_data/annotations.rds") |
  ...
  anns_wide <- readRDS("analysis/data/derived_data/annotations_wide_treated.rds")
}
...
bp <- anns_wide_animals_joined_mut %>% 
  ...
  labs(x = "Detection time (in days)",
       ...
       color = "Ecozone") + 
  theme_bw()
ggsave(plot = bp, filename = "analysis/figures/bp.png", width = 10, height = 15)
...
pts <- anns_wide_animals_joined_mut %>% 
  ...
  labs(x = "Detection time (in days)",
       ...
       size = "Day counts") + 
  theme_bw()
ggsave(plot = pts, filename = "analysis/figures/pts.png", width = 10, height = 15)
pts
```
