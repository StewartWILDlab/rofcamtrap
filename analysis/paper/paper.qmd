...
ggplot2::ggplot() +
  ggplot2::theme_bw() +
  ggplot2::geom_sf(data = zones_filter) +
  ggplot2::geom_sf(data = sf::st_jitter(cams_sf, 0.05), cex = 0.5, 
                   ggplot2::aes(col=is_retrieved)) +
  ggplot2::coord_sf(xlim = c(-89, -84),
                    ylim = c(50, 55)) +
  ggplot2::labs(col = "Camera \nRetrieved")
```
...
ggplot2::ggplot(zones_filter) +
  ggplot2::theme_bw() +
  ggplot2::geom_sf() +
  ggplot2::geom_sf(data = sf::st_jitter(cams_sf_clust, 0.05), cex = 1, 
                   ggplot2::aes(col = grp)) +
  ggplot2::coord_sf(xlim = c(-89, -84),
                    ylim = c(50, 55))
```
...
ggplot2::ggplot(zones_filter) +
  ggplot2::theme_bw() +
  ggplot2::geom_sf() +
  ggplot2::geom_sf(data = sf::st_jitter(cams_sf_geo_clust, 0.05), cex = 1, 
                   ggplot2::aes(col = grp)) +
  ggplot2::coord_sf(xlim = c(-89, -84),
                    ylim = c(50, 55))
```
...
cams_sf_sp %>%
  ...
  ggplot2::geom_density_2d_filled(binwidth = 0.05) +
...
cams_sf_sp %>%
  ...
  ggplot2::ggplot(ggplot2::aes(X, Y)) +
  ggplot2::geom_density_2d_filled(breaks = c(seq(0,1,by=0.1),5, 10, 20, 50,100),
                                  n=20) +
...
for (sp in unique(cams_sf_sp_sum$species)){
  ...
  gg <- ggplot2::ggplot(zones_filter) +
    ggplot2::theme_bw() +
    ggplot2::geom_sf() +
  ...
  ggplot2::ggsave(gg, filename = paste0("analysis/figures/",sp,".png"))
}
```
