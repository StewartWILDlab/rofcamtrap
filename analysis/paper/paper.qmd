...
@fig-map-pies show relative species abundances at plot sites, for species detected more than 50 days in the season.
...
@fig-rda-pa shows the triplot for the RDA on presence-absence data.
...
@fig-rda-events shows the triplot for the RDA on relative abundance data.
...
@fig-rda-events-clust shows the triplot for the RDA on relative abundance data,  with Ward clusters as ellipses.
...
@fig-map-clust shows a map of clustered camera sites.
...
@fig-map-clust-geo shows a map of geographically constrained clustered camera sites.
